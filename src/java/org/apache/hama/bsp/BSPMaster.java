...
public class BSPMaster implements JobSubmissionProtocol, MasterProtocol, // InterServerProtocol,
  ...
  @Override
  public void saveResultOver(BSPJobID jobId, int parId, int saveRecordNum, int passes, double contributions) {
	  jobs.get(jobId).saveResultOver(parId, saveRecordNum, passes, contributions);
  }
